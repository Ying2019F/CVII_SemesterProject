...
train_data = "examples/amazon/amazon_trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "examples/amazon/amazon_test_lmdb"
...
model_name = "VGG_amazon_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/amazon/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/amazon/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/amazon/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/VOCdevkit/results/amazon/{}_score/Main".format(os.environ['HOME'], job_name)
...
name_size_file = "data/amazon/test_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = "data/amazon/labelmap_amazon.prototxt"
